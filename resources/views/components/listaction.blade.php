                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-md-9 col-lg-6 col-xl-5">
                        <div class="mx-auto mb-5">
                            ...
                            <h2 class="display-5 fw-bold mt-2 mb-4">Lorem ipsum dolor sit amet consectutar domor at elis
                            </h2>
                    ...
                    <div class="col-12 col-md-9 col-lg-6 col-xl-5 offset-xl-2">
                        <div class="px-4 py-5 px-lg-5 bg-light rounded mx-auto">
                            <div class="d-flex mb-5">
                                ...
                                <div>
                                    <p class="lead text-muted">Etiam pellentesque non nibh non pulvinar. Mauris posuere,
                                        tellus sit amet tempus vestibulum.</p>
                                </div>
                            </div>
                            <div class="d-flex mb-5">
                                <span
